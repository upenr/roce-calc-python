...
for i in range(0, len(snpSymbols)):  # len(dowSymbols)
    try:
        ...
        url_is_y = 'https://financialmodelingprep.com/api/v3/financials/income-statement/' + snpSymbols[i] + '?apikey='+my_value_a
        #url_is_y = 'https://finnhub.io/api/v1/stock/financials?symbol='+ snpSymbols[i] + '&statement=ic&freq=annual&token='
        url_bs_y = 'https://financialmodelingprep.com/api/v3/financials/balance-sheet-statement/' + snpSymbols[i] + '?apikey='+my_value_a
